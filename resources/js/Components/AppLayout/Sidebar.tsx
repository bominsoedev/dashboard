                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <Link href="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span
                                className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t(import.meta.env.APP_NAME || 'KYAW ZAY YA')}</span>
                        </Link>
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className={'nav-item'}>
                                        <Link href={'/session/admin/dashboard'}>
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="nav-item">
                                        <Link href={'/session/admin/articles'} className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span
                                                    className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('articles')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                </ul>
                            ...
                            <li className="menu nav-item">
                                <Link href={'/session/admin/categories/category'} className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('category')}</span>
                                    </div>
                                </Link>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <Link href={'/session/admin/tags/tag'} className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20"
                                             viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('tag')}</span>
                                    </div>
                                </Link>
                            </li>
                            <h2 className="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                            ...
                            <li className="menu nav-item">
                                <Link href={'/session/admin/portfolios/portfolio'} className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20"
                                             viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('portfolio')}</span>
                                    </div>
                                </Link>
                            </li>
                            <h2 className="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                            ...
                            <li className="menu nav-item">
                                <Link href={'/session/admin/tools'} className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20"
                                             viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('tools')}</span>
                                    </div>
                                </Link>
                            </li>
                            ...
                            <h2 className="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                                ...
                                <span>{t('tools_section')}</span>
                            </h2>
                            <li className="menu nav-item">
                                <Link href={'/session/admin/tool_sections/tool_section'} className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20"
                                             viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('tools_section')}</span>
                                    </div>
                                </Link>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <Link href={'/session/admin/profile'} className="nav-link group">
                                    <div className="flex items-center">
                                        ...
                                        <span
                                            className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('profile')}</span>
                                    </div>
                                </Link>
                            </li>
                        </ul>
