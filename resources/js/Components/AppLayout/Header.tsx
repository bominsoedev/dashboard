                ...
                <div className='relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black'>
                    <div className='horizontal-logo flex lg:hidden items-center ltr:mr-2 rtl:ml-2'>
                        <Link href={''} className='main-logo flex items-center shrink-0'>
                            ...
                            <span
                                className='text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300'>{import.meta.env.APP_NAME || 'KYAW ZAY YA'}</span>
                        </Link>
                        <button
                            type='button'
                    ...
                    <div
                        className='sm:flex-1 justify-end ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]'>
                       <ModeToggle/>
                        <div className='dropdown shrink-0'>
                            <Dropdown
                                ...
                                button={<img className='w-5 h-5 object-cover rounded-full'
                                             src={`/assets/images/flags/${flag.toUpperCase()}.svg`} alt='flag' />}
                            >
                                            ...
                                            <li key={item.code}>
                                                ...
                                                >
                                                    <img src={`/assets/images/flags/${item.code.toUpperCase()}.svg`}
                                                         alt='flag' className='w-5 h-5 object-cover rounded-full' />
                        ...
                        <div className='dropdown shrink-0 flex'>
                            <Dropdown
                                ...
                                button={<img
                                    ...
                                    src='/Profile/profile1.jpg' alt='userProfile' />}
                            >
                                <ul className='text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90'>
                                        ...
                                        <div className='flex items-center px-4 py-4'>
                                            ...
                                            <div className='ltr:pl-4 rtl:pr-4 truncate'>
                                                <h4 className='text-base'>
                                                    {auth.user.name}
                                                    <span
                                                        className='text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2'>ADMIN</span>
                                                </h4>
                                                <button type='button'
                                    ...
                                    <li className='border-t border-white-light dark:border-white-light/10'>
                                        <Link href={route('logout')} method={'POST'} className='text-danger !py-3'>
