...
const CreateOrEdit = ({category = null}: { category: any }) => {
            ...
            <Modal show={confirming} onClose={closeModal}>
                <form onSubmit={handleDelete} className="p-6">
                    <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">
                        Destroy Category : {category.name}
                    </h2>

                    <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">
                        Do you really want to delete category <span
                        className={'text-red-500 uppercase font-extrabold'}>{category.name}</span> ?.
                    </p>
