...
const Index = ({toolSections}: { toolSections: any }) => {
    ...
    const [filteredItems, setFilteredItems] = useState<any>(toolSections);
    ...
    useEffect(() => {
        setFilteredItems(() => {
            return toolSections.data.filter((item: any) => {
            ...
            <Authenticated>
                ...
                <PerfectScrollbar
                    ...
                    {filteredItems.length ? (
                        <>
                            {filteredItems.map((toolSection: any) => {
                                return (
                                    <ul role={toolSection.tools_sectionKey} className="">
                                        <div className="">
                                            <li
                                                key={toolSection.tools_sectionKey}
                                            ...
                                            >
                                                <div
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="flex gap-2">
                                                            <CreateOrEdit edit={true} toolsSection={toolSection}/>
                                                            <DangerButton
                                                ...
                                                <div
                                                    ...
                                                    <div className="min-w-0  justify-start">
                                                        <p className="text-sm font-semibold leading-6">Section
                                                            Name</p>
                                                        <span
                                                ...
                                                <div
                                                    ...
                                                    <p className="mt-1 text-sm font-bold truncate leading-5 text-gray-500">
                                                        <time dateTime={toolSection.created_at}>
                                                            {formatDate(toolSection.created_at)}
                                                        </time>
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p className="text-sm font-semibold leading-6">Updated
                                                        Date</p>
                                                    <p className="mt-1 text-sm font-bold truncate leading-5 text-gray-500">
                                                        <time dateTime={toolSection.updated_at}>
                                                            {formatDate(toolSection.updated_at)}
                                                        </time>
                                                    </p>
                                                </div>
                ...
                <div className={'mt-5'}>
                    <div className="flex justify-center flex-col w-full">
                        <ul className="inline-flex items-center space-x-1 rtl:space-x-reverse m-auto mb-4">
                            {toolSections.links.map((link: any, index: any) => {
                                    return (
                                        <li key={index}>
                                            <Link
